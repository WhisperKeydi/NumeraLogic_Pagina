Para Windows:
En XAMPP activa apache y SQL, posteriormente, clona la carpeta (carpeta de github) dentro de htdocs
...
-- Tabla de usuarios (SIMPLIFICADA - eliminado email duplicado)
...
-- Tabla para visitas a cursos específicos (SIMPLIFICADA - eliminada columna calculada problemática)
...
-- Agregar índice al email para búsquedas más rápidas
ALTER TABLE usuarios ADD INDEX idx_email (email);

-- Insertar usuario de prueba (ID 1) CON CONTRASEÑA HASHEADA
-- Contraseña: '123' hasheada con password_hash('123', PASSWORD_DEFAULT)
INSERT INTO usuarios (matricula, contrasena, nombre, email) 
VALUES ('00', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Usuario Demo', 'usuario@demo.com');
...
-- Insertar estadísticas iniciales para el usuario demo
INSERT INTO usuario_estadisticas (usuario_id) VALUES (1);

-- Insertar racha inicial para el usuario demo
INSERT INTO usuario_rachas (usuario_id) VALUES (1);

-- Insertar token de demostración para el usuario de prueba (ID 1)
INSERT INTO password_reset_tokens (usuario_id, token, expiracion, usado) 
VALUES (1, 'demo', DATE_ADD(NOW(), INTERVAL 1 HOUR), 0);
```
