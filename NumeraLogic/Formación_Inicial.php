...
<main>
    <div class="content-wrapper">
      <div class="courses-section">
        ...
        <a href="tallerMate_pagina.php" class="course-card">
          <div class="course-icon">📐</div>
          <h3>Taller de Matemáticas</h3>
        </a>

        <a href="tallerAlgo_pagina.php" class="course-card">
          <div class="course-icon">🔀</div>
          <h3>Taller de Algoritmos</h3>
        </a>

        <a href="introduccionCalculo_pagina.php" class="course-card">
          <div class="course-icon">📊</div>
          <h3>Introducción al cálculo</h3>
        </a>

        <a href="calculo1_pagina.php" class="course-card">
          <div class="course-icon" style="font-size: 6rem; font-weight: 700; color: #10b981;">1</div>
          <h3>Cálculo I</h3>
        </a>

        <a href="calculo2_pagina.php" class="course-card">
          <div class="course-icon" style="font-size: 6rem; font-weight: 700; color: #10b981;">2</div>
          <h3>Cálculo II</h3>
        </a>

        <a href="algebraLineal_pagina.php" class="course-card">
          <div class="course-icon">📈</div>
